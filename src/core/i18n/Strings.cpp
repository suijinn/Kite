...
const Row kEn[] = {
    ...
    { "cmd.filter", "Filter" },
    { "cmd.search", "Search below this folder" },
    ...
    { "cmd.toggle_group", "Group by the sort column" },
    { "cmd.reset_column_widths", "Reset column widths" },
    { "cmd.folder_size", "Count folder size" },
    { "cmd.folder_sizes", "Count every folder size here" },
    { "cmd.folder_sizes_stop", "Stop counting folder sizes" },
    ...
    { "cmd.restore", "Restore from Recycle Bin" },
    ...
    { "ui.columns_reset", "Column widths are back to their defaults" },
    { "ui.tab_bar_reset", "Tab bar width is back to its default" },
    { "ui.sidebar_reset", "Sidebar width is back to its default" },
    { "ui.tabs_in_sidebar_hidden", "Tabs move into the sidebar once it is shown" },
    { "ui.tabs_in_sidebar_split", "Tabs stay beside each pane while the session is split" },
    { "ui.age", "Age" },
    { "ui.age_now", "just now" },
    { "ui.age_minutes", "{0} min ago" },
    { "ui.age_hours", "{0} hr ago" },
    { "ui.age_days", "{0} d ago" },
    { "ui.age_months", "{0} mo ago" },
    { "ui.age_years", "{0} yr ago" },
    { "ui.group_folders", "Folders" },
    { "ui.group_no_ext", "No extension" },
    { "ui.group_unknown", "Unknown" },
    ...
    { "ui.status_usage", "{0} / {1} used" },
    { "ui.filter_label", "Filter:" },
    { "ui.search_label", "Search:" },
    { "ui.search_hint", "Type a name to search below {0}" },
    { "ui.search_running", "Searching {0}" },
    { "ui.search_done", "Search {0}" },
    { "ui.search_truncated", "Search {0} (stopped at {1} matches)" },
    { "ui.search_no_match", "Nothing under this folder matches" },
    { "ui.search_unsupported", "This listing cannot be searched" },
    ...
    { "ui.confirm_default_manager",
      "Let Kite open folders and Win+E instead of File Explorer? Enter = yes, Esc = no" },
    { "ui.confirm_default_manager_off",
      "Give folders and Win+E back to File Explorer? Enter = yes, Esc = no" },
    { "ui.key_help_title", "Keyboard shortcuts" },
    { "ui.key_help_hint", "{0} to rebind, or edit keys.ini. Esc closes." },
    { "ui.key_help_hint_unbound", "Edit keys.ini to rebind. Esc closes." },
    ...
    { "ui.goto_title", "Places" },
    { "ui.goto_hint", "Enter: go   Ctrl+Enter: new tab   >: commands   Esc: close" },
    { "ui.goto_search_hint", "Type to search" },
    { "ui.goto_count", "{0} places" },
    { "ui.goto_empty", "Nothing matches that" },
    { "ui.goto_kind_bookmark", "Bookmark" },
    { "ui.goto_kind_tab", "Open tab" },
    { "ui.goto_kind_quick", "Quick access" },
    { "ui.goto_kind_drive", "Drive" },
    { "ui.goto_kind_history", "History" },
    { "ui.goto_none", "Nowhere to go yet. Ctrl+D bookmarks this folder." },
    { "ui.command_palette_title", "Commands" },
    { "ui.command_palette_hint", "Enter: run   Backspace on >: places   Esc: close" },
    { "ui.command_palette_search_hint", "Type to search" },
    { "ui.command_palette_count", "{0} commands" },
    { "ui.command_palette_empty", "Nothing matches that" },
    { "ui.command_palette_unbound", "no shortcut" },
    { "ui.command_palette_target", "{0} - {1}" },
    { "ui.settings_title", "Settings" },
    { "ui.settings_hint", "Left/Right or Enter: change   {0}: shortcuts   Esc: close" },
    { "ui.settings_hint_unbound", "Left/Right or Enter: change   Esc: close" },
    ...
    { "settings.group.files", "Files" },
    { "settings.group.columns", "Columns" },
    ...
    { "settings.font_size", "Base text size" },
    { "settings.font_scale", "Text size" },
    { "settings.percent", "{0}%" },
    { "settings.pixels", "{0} px" },
    ...
    { "settings.tab_bar_pos.sidebar", "In the sidebar" },
    ...
    { "settings.open_archives", "Open archives as folders" },
    { "settings.folder_sizes", "Count folder sizes" },
    { "settings.folder_sizes.off", "Never" },
    { "settings.folder_sizes.manual", "When asked" },
    { "settings.folder_sizes.auto", "Automatically" },
    { "settings.show_hidden", "Show hidden files" },
    { "settings.dirs_first", "Folders first" },
    { "settings.group_rows", "Group rows" },
    { "settings.default_manager", "Default file manager" },
    { "settings.on", "On" },
    { "settings.off", "Off" },
    { "settings.yes", "Yes" },
    { "settings.no", "No" },
    ...
    { "ui.duplicated", "Duplicated {0} item(s)" },
    { "ui.size_counting", "{0}..." },
    { "ui.folder_size_counting", "Measuring {0} folder(s)" },
    { "ui.folder_size_detail", "{0} files, {1} folders" },
    { "ui.folder_size_incomplete", "some parts could not be read" },
    { "ui.folder_size_stopped", "Stopped measuring" },
    { "ui.folder_size_disabled", "Folder sizes are turned off ({0})" },
    { "ui.folder_size_unsupported", "Folder sizes cannot be measured here" },
    { "ui.folder_size_no_folder", "Select a folder to measure" },
    { "ui.vfolder_computer", "PC" },
    { "ui.vfolder_recycle_bin", "Recycle Bin" },
    { "ui.vfolder_network", "Network" },
    { "ui.vfolder_read_only", "This is a list, not a folder - act on an item from the shell menu" },
    { "ui.archive_read_only", "Kite does not write inside an archive - extract from the shell menu" },
    { "ui.vfolder_failed", "This location could not be listed" },
    { "ui.open_failed", "Could not open this item" },
    { "ui.opened_copy", "Opened read-only" },
    { "ui.restored", "Restored {0} item(s)" },
    { "ui.restore_failed", "Could not restore" },
    { "ui.restore_not_trash", "Only items in the Recycle Bin can be restored" },
    { "ui.not_network_path", "This is not a network location" },
    { "ui.terminal_failed", "Could not open a terminal here" },
    ...
    { "ui.copying", "Copying..." },
    { "ui.moving", "Moving..." },
    { "ui.file_op_running", "{0} file operations running" },
    { "ui.file_op_more", "  ({0} waiting)" },
    { "ui.file_op_busy", "Wait for the file operation to finish" },
    { "ui.rename_failed", "Could not rename" },
    { "ui.create_failed", "Could not create it" },
    { "ui.delete_failed", "Could not delete" },
    { "ui.copy_failed", "Could not copy" },
    { "ui.move_failed", "Could not move" },
    { "ui.undo_failed", "Could not undo" },
    { "ui.saved", "Workspace saved" },
    { "ui.default_manager_set",
      "Kite now opens folders and Win+E. Undo it with \"Stop being the default file "
      "manager\"." },
    { "ui.default_manager_cleared", "Folders go back to File Explorer" },
    { "ui.default_manager_already", "Kite is already the default file manager" },
    { "ui.default_manager_not_set", "Kite is not the default file manager" },
    { "ui.default_manager_failed", "Could not change the default file manager" },
    { "ui.default_manager_unsupported", "This system has no default file manager to set" },
    { "ui.default_manager_moved",
      "Another copy of Kite is registered as the default file manager. Run \"Make Kite the "
      "default file manager\" to point it here." },
    ...
    { "ui.cannot_detach_last", "The only tab cannot be pulled out" },
    { "ui.standalone_no_save", "This window does not save its workspace" },
    { "ui.undo_empty", "Nothing to undo" },
    { "ui.undo_no_erase", "A permanent delete cannot be undone" },
    ...
    { "ui.undone_delete", "Delete undone" },
...
const Row kJa[] = {
    ...
    { "cmd.toggle_group", "並べ替えの基準でまとめる" },
    { "cmd.reset_column_widths", "列幅を既定に戻す" },
    { "cmd.folder_size", "フォルダのサイズを数える" },
    { "cmd.folder_sizes", "この一覧のフォルダをすべて数える" },
    { "cmd.folder_sizes_stop", "フォルダのサイズを数えるのをやめる" },
    ...
    { "ui.size", "サイズ" },
    { "ui.modified", "更新日時" },
    { "ui.columns_reset", "列幅を既定に戻しました" },
    { "ui.tab_bar_reset", "タブバーの幅を既定に戻しました" },
    { "ui.sidebar_reset", "サイドバーの幅を既定に戻しました" },
    { "ui.tabs_in_sidebar_hidden", "サイドバーを表示すると、タブはその中に入ります" },
    { "ui.tabs_in_sidebar_split", "分割している間、タブは各ペインの脇に出ます" },
    { "ui.age", "経過時間" },
    { "ui.age_now", "たった今" },
    { "ui.age_minutes", "{0} 分前" },
    { "ui.age_hours", "{0} 時間前" },
    ...
    { "ui.age_months", "{0} か月前" },
    { "ui.age_years", "{0} 年前" },
    { "ui.group_folders", "フォルダー" },
    { "ui.group_no_ext", "拡張子なし" },
    { "ui.group_unknown", "不明" },
    ...
    { "ui.status_usage", "使用 {0} / {1}" },
    { "ui.filter_label", "絞り込み:" },
    { "ui.search_label", "検索:" },
    { "ui.search_hint", "{0} の下から探す名前を入力してください" },
    { "ui.search_running", "検索中 {0}" },
    { "ui.search_done", "検索 {0}" },
    { "ui.search_truncated", "検索 {0}（{1} 件で打ち切りました）" },
    { "ui.search_no_match", "このフォルダーの下には見つかりませんでした" },
    { "ui.search_unsupported", "この一覧は検索できません" },
    ...
    { "ui.confirm_default_manager",
      "フォルダーと Win+E をエクスプローラーではなく Kite で開くようにしますか？ "
      "Enter=はい / Esc=いいえ" },
    { "ui.confirm_default_manager_off",
      "フォルダーと Win+E をエクスプローラーに戻しますか？ "
      "Enter=はい / Esc=いいえ" },
    { "ui.confirm_delete_perm", "{0} 件を完全に削除しますか？ Enter=はい / Esc=いいえ" },
    { "ui.key_help_title", "キーボードショートカット" },
    { "ui.key_help_hint", "{0} または keys.ini で変更できます。Esc で閉じます。" },
    { "ui.key_help_hint_unbound", "keys.ini で変更できます。Esc で閉じます。" },
    ...
    { "ui.goto_title", "行き先" },
    { "ui.goto_hint", "Enter: 移動   Ctrl+Enter: 新しいタブ   >: コマンド   Esc: 閉じる" },
    { "ui.goto_search_hint", "文字を入力すると絞り込めます" },
    { "ui.goto_count", "{0} 件" },
    { "ui.goto_empty", "該当するものがありません" },
    { "ui.goto_kind_bookmark", "ブックマーク" },
    { "ui.goto_kind_tab", "開いているタブ" },
    { "ui.goto_kind_quick", "クイックアクセス" },
    { "ui.goto_kind_drive", "ドライブ" },
    { "ui.goto_kind_history", "履歴" },
    { "ui.goto_none", "行き先がありません。Ctrl+D でこのフォルダをブックマークに追加できます" },
    { "ui.command_palette_title", "コマンド" },
    { "ui.command_palette_hint", "Enter: 実行   > を消す: 行き先   Esc: 閉じる" },
    { "ui.command_palette_search_hint", "文字を入力すると絞り込めます" },
    { "ui.command_palette_count", "{0} 件" },
    { "ui.command_palette_empty", "該当するものがありません" },
    { "ui.command_palette_unbound", "未割り当て" },
    { "ui.command_palette_target", "{0}（{1}）" },
    { "ui.settings_title", "設定" },
    { "ui.settings_hint", "←→ または Enter: 変更   {0}: ショートカットキー   Esc: 閉じる" },
    { "ui.settings_hint_unbound", "←→ または Enter: 変更   Esc: 閉じる" },
    ...
    { "settings.group.files", "ファイル" },
    { "settings.group.columns", "列" },
    ...
    { "settings.tab_bar_pos.sidebar", "サイドバーの中" },
    { "settings.new_tab_pos", "新しいタブを開く位置" },
    { "settings.new_tab_pos.end", "末尾（右端）" },
    { "settings.new_tab_pos.after", "現在のタブの右" },
    { "settings.open_archives", "書庫をフォルダとして開く" },
    { "settings.folder_sizes", "フォルダのサイズを数える" },
    { "settings.folder_sizes.off", "数えない" },
    { "settings.folder_sizes.manual", "頼まれたときだけ" },
    { "settings.folder_sizes.auto", "自動で" },
    { "settings.show_hidden", "隠しファイルを表示" },
    { "settings.dirs_first", "フォルダを先頭にまとめる" },
    { "settings.group_rows", "同じ値をまとめる" },
    { "settings.default_manager", "既定のファイルマネージャー" },
    { "settings.on", "オン" },
    { "settings.off", "オフ" },
    { "settings.yes", "はい" },
    { "settings.no", "いいえ" },
    ...
    { "ui.duplicated", "{0} 件の複製を作りました" },
    { "ui.size_counting", "{0}…" },
    { "ui.folder_size_counting", "サイズを計測中（{0} 件）" },
    { "ui.folder_size_detail", "ファイル {0}・フォルダ {1}" },
    { "ui.folder_size_incomplete", "一部を読み取れませんでした" },
    { "ui.folder_size_stopped", "計測をやめました" },
    { "ui.folder_size_disabled", "フォルダのサイズは数えない設定です（{0}）" },
    { "ui.folder_size_unsupported", "ここではフォルダのサイズを数えられません" },
    { "ui.folder_size_no_folder", "数えるフォルダを選んでください" },
    { "ui.vfolder_computer", "PC" },
    { "ui.vfolder_recycle_bin", "ごみ箱" },
    { "ui.vfolder_network", "ネットワーク" },
    { "ui.vfolder_read_only", "ここは一覧であってフォルダーではありません。項目への操作は右クリックのメニューから" },
    { "ui.archive_read_only", "書庫の中は Kite からは変更できません。取り出しは右クリックのメニューから" },
    { "ui.vfolder_failed", "この場所の一覧を取得できませんでした" },
    { "ui.open_failed", "この項目を開けませんでした" },
    { "ui.opened_copy", "読み取り専用で開きました" },
    { "ui.restored", "{0} 件を元の場所へ戻しました" },
    { "ui.restore_failed", "元に戻せませんでした" },
    { "ui.restore_not_trash", "元に戻せるのはごみ箱の項目だけです" },
    { "ui.not_network_path", "ここはネットワークの場所ではありません" },
    { "ui.terminal_failed", "ここではターミナルを開けませんでした" },
    ...
    { "ui.copying", "コピーしています…" },
    { "ui.moving", "移動しています…" },
    { "ui.file_op_running", "ファイル操作を {0} 件実行中" },
    { "ui.file_op_more", "（他 {0} 件待機中）" },
    { "ui.file_op_busy", "実行中のファイル操作が終わるまで待ってください" },
    { "ui.rename_failed", "名前を変更できませんでした" },
    { "ui.create_failed", "作成できませんでした" },
    { "ui.delete_failed", "削除できませんでした" },
    { "ui.copy_failed", "コピーできませんでした" },
    { "ui.move_failed", "移動できませんでした" },
    { "ui.undo_failed", "元に戻せませんでした" },
    { "ui.saved", "ワークスペースを保存しました" },
    { "ui.default_manager_set",
      "フォルダーと Win+E が Kite で開くようになりました。"
      "「既定のファイルマネージャーの登録を解除」で元に戻せます" },
    { "ui.default_manager_cleared", "フォルダーはエクスプローラーで開くようになりました" },
    { "ui.default_manager_already", "すでに既定のファイルマネージャーになっています" },
    { "ui.default_manager_not_set", "既定のファイルマネージャーになっていません" },
    { "ui.default_manager_failed", "既定のファイルマネージャーを変更できませんでした" },
    { "ui.default_manager_unsupported", "この環境には既定のファイルマネージャーの設定がありません" },
    { "ui.default_manager_moved",
      "別の場所にある Kite が既定のファイルマネージャーとして登録されています。"
      "「既定のファイルマネージャーにする」でこの Kite に付け替えられます" },

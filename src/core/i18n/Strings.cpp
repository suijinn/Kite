...
const Row kEn[] = {
    ...
    { "ui.goto_hint", "Enter: go   Ctrl+Enter: new tab   Esc: close" },
    ...
    { "ui.command_palette_hint", "Enter: run   Esc: close" },
...
const Row kJa[] = {
    ...
    { "ui.goto_title", "行き先" },
    { "ui.goto_hint", "Enter: 移動   Ctrl+Enter: 新しいタブ   Esc: 閉じる" },
    ...
    { "ui.command_palette_hint", "Enter: 実行   Esc: 閉じる" },
